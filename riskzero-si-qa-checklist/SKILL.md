...
이 스킬은 riskzero-si 8단계 파이프라인의 **Step 6**이다. 체크리스트 생성 후 답변 맨 끝에 아래 푸터를 반드시 출력한다. (`{기능명}`은 검증 대상 메뉴/기능명으로 채운다.)
...
> |---|------|------|------|
> | 1~5 | 계획~PR리뷰 | … | ✅ |
> | 6 | QA 체크리스트 | `riskzero-si-qa-checklist` | 👉 방금 완료 |
> | 7 | 버그 수정 | `riskzero-si-qa` | 👉 다음 |
> | 8 | 최종 검증 | `riskzero-si-browse` | ⬜ |
>
> **방금 완료:** Step 6 — 산출물: `.si-planning/{기능명}/qa-checklist.md`
>
